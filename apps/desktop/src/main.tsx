...
function App() {
  ...
  React.useEffect(() => { const workspace = workspaces.find((item) => item.id === currentWorkspaceId); if (workspace) setProfile(workspace.profile); }, [currentWorkspaceId, workspaces]);
